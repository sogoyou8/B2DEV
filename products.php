...
// Sélectionner uniquement les produits actifs (is_active = 1 par défaut si NULL)
// Trier par date de création décroissante pour afficher les plus récents en premier
try {
    $query = $pdo->query("SELECT * FROM items WHERE IFNULL(is_active,1) = 1 ORDER BY created_at DESC");
    $products = $query->fetchAll(PDO::FETCH_ASSOC);
} catch (Exception $e) {
    $products = [];
    $_SESSION['error'] = "Impossible de récupérer les produits : " . $e->getMessage();
}
...
// Placeholder SVG si pas d'image disponible
    ...
    <section class="products-section bg-light p-5 rounded shadow-sm">
        ...
        <div class="row">
            <?php foreach ($products as $product): ?>
                ...
                // Stock (peut être absent) — utilisé pour masquer le bouton d'ajout si rupture
                ...
                <div class="col-md-4 mb-4">
                    <!-- data-href utilisé par le script JS pour naviguer.
                         tabindex rend la carte focalisable pour l'accessibilité clavier. -->
                    <div class="card h-100 position-relative product-card" data-href="<?php echo $detailUrl; ?>" tabindex="0" role="link" aria-label="Voir <?php echo $pname; ?>">
                        ...
                        <?php if (!empty($images)): ?>
                            <div id="carouselProduct<?php echo $pid; ?>" class="carousel slide" data-ride="carousel" data-interval="false">
                                ...
                                <?php if (count($images) > 1): ?>
                                    <a class="carousel-control-prev" href="#carouselProduct<?php echo $pid; ?>" role="button" data-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="sr-only">Previous</span>
                                    </a>
                                    <a class="carousel-control-next" href="#carouselProduct<?php echo $pid; ?>" role="button" data-slide="next">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto d-flex justify-content-between align-items-center">
                                ...
                                <!-- espace réservé (optionnel) -->
                                <div class="card-actions">
                                    <!-- preserved for layout; replaced by mini-actions below -->
                                </div>
                            </div>

                            <!-- Mini actions en bas à droite (panier + favoris) avec design ultra moderne -->
                            <div class="ultra-actions" aria-hidden="false">
                                ...
                                <!-- Favorites avec design ultra moderne -->
...
// Exclure les interactions quand le click provient d'un bouton, d'un lien, d'un input, ou d'un form.
(function () {
    ...
    document.querySelectorAll('.product-card').forEach(function(card){
        ...
        card.addEventListener('click', function(e){
            ...
            // ensure not a click on SVG parts used inside buttons
        ...
        card.addEventListener('keydown', function(e){
            if (e.key === 'Enter' || e.key === ' ') {
                ...
                if (active && active !== card && active.closest && active.closest('button, a, form, input, select, textarea')) {
                    return; // allow default interactive controls
                }
                e.preventDefault();
                window.location.href = href;
            }
